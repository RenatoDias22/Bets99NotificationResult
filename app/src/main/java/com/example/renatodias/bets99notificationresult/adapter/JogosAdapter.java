...
public class JogosAdapter extends  RecyclerView.Adapter<JogosAdapter.ViewHolder> {
    ...
    private Jogo[] jogos = {
            new Jogo(0  , "Palmeiras", "Corinthians","21/08/2017 21:00"),
            new Jogo(1  , "Santos", "Ponte Preta", "21/08/2017 21:00"),
            new Jogo(2  , "Avai", "Vitoria", "21/08/2017 21:00"),
            new Jogo(3  , "Sao Paulo", "Bota fogo", "21/08/2017 21:00"),
            new Jogo(4  , "Flamengo", "Fluminanse", "21/08/2017 21:00"),
            new Jogo(5  , "Vasco", "Botafogo", "21/08/2017 21:00"),
            new Jogo(6  , "Gremio", "Internacional", "21/08/2017 21:00"),
            new Jogo(7  , "Atletico-MG", "Atletico-PR", "21/08/2017 21:00"),
    };
